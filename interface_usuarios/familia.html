...
<head>
  ...
  <title>Família e Adolescentes - FerroviaX</title>
...
<body>
  <div class="app">
    <header class="familia-header">
      ...
      <h1>Família e Adolescentes</h1>
    </header>

    <main class="familia-container">
      <section class="familia-explicacao">
        <p>Com o recurso de Família do FerroviaX, você pode adicionar membros para compartilhar benefícios, acompanhar
          viagens de adolescentes e gerenciar pagamentos familiares.</p>
      </section>

      <section class="familia-opcoes">
        <div class="familia-card">
          <h3>Gerenciar Grupo Familiar</h3>
          <p>Adicione ou remova membros, veja o histórico de viagens e controle os pagamentos do grupo.</p>
          <button onclick="alert('Gerenciar grupo')">Acessar</button>
        </div>

        <div class="familia-card">
          <h3>Permitir viagens para adolescentes</h3>
          <p>Habilite o uso do app por adolescentes com controle e notificações em tempo real.</p>
          <button onclick="alert('Configurar permissões')">Configurar</button>
        </div>
      </section>
    </main>
