...
select, input, button { border-radius: 6px !important; }

.footer-nav {
  background: #fff; border-top: 1px solid #ddd; padding: 6px 0;
}
.nav-container {
...
.nav-item.active span, .nav-item.active .icon {
  opacity: 1; color: #007bff; transform: scale(1.1);
}
